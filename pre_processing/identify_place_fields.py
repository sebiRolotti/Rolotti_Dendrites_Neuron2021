...
def define_fields(tuning_curve):
    ...
    for local_max in local_maxima:
        ...
        popt, pcov = curve_fit(
            gaussian_func, x_data, data_to_fit, p0=[.1, 1], **{'maxfev' : 1200})
...
def id_place_fields(expt, intervals='running', n_position_bins=100,
    ...
    if n_position_bins > n_bins_list[0] and n_position_bins % n_bins_list[0] == 0:
        n_bins_list.insert(n_position_bins)
    if smooth_length > smooth_lengths[0]:
        smooth_lengths.insert(smooth_length)
